...
instance Print AbsCPP.Exp where
  prt i = \case
    ...
    AbsCPP.EPIncr id_ -> prPrec i 14 (concatD [prt 0 id_, doc (showString "++")])
    AbsCPP.EPDecr id_ -> prPrec i 14 (concatD [prt 0 id_, doc (showString "--")])
    AbsCPP.EIncr id_ -> prPrec i 13 (concatD [doc (showString "++"), prt 0 id_])
    AbsCPP.EDecr id_ -> prPrec i 13 (concatD [doc (showString "--"), prt 0 id_])
    ...
    AbsCPP.EAss id_ exp -> prPrec i 2 (concatD [prt 0 id_, doc (showString "="), prt 2 exp])
